...
\begin{frame}{Pregunta de investigación}
    ...
    \begin{wideitemize}
        ...
        \item <2-> La literatura ha analizado este fenómeno principalmente como un choque de productividad (costos).
        \begin{itemize}
        ...
        \item <4-> \textbf{\color{amaranth} ¿Cómo el estrés térmico reconfigura el equilibrio estratégico y el bienestar en los mercados de bienes agrícolas?}
    \end{wideitemize}
\end{frame}
...
\begin{frame}{En este trabajo}
    ...
    \begin{wideitemize}
        ...
        \item <2-> Estimación del impacto del estrés térmico en 1990-2019. Efectos en precios, cantidades y excedente total.

        \item <3-> Descomposición del impacto total: efecto en costos + efecto estratégico.
        
        \item <4-> Hallazgos
        \begin{itemize}
        \item <4-> \textbf{\color{amaranth} El estrés térmico incrementa los costos marginales.}
        \item <4-> \textbf{\color{amaranth} Pero el efecto estratégico mitiga este impacto directo.}
        \item <4-> \textbf{\color{amaranth} La magnitud relativa de ambos elementos genera ganadores y perdedores netos.}
    \end{itemize}
...
\begin{frame}{El mercado internacional del café}
    ...
    \setbeamertemplate{itemize items}[circle]
    \begin{wideitemize}
        \item \textbf{El grano verde de café:}
        \begin{itemize}
        ...
        \begin{itemize}
            \item Cantidades responden a umbrales de temperaturas extremas.
        \end{itemize}
    \end{wideitemize}            
\end{frame}
...
\begin{frame}{Datos y variable de estrés térmico}
    ...
    \begin{wideitemize}
        ...
        \item \textbf{Fuentes clave:}
            \begin{itemize}
                \item \textit{USDA} (exportaciones anuales, mill. 60 kg).
                \item \textit{ICO} (índice global de precios, ¢/lb).
        ...
        \item \textbf{Estrés térmico:} Días de exposición a temperaturas extremas en un año. \hyperlink{frame:variable_estres}{\beamerbutton{Ver}}
    \end{wideitemize}
\end{frame}
...
\begin{frame}{Conclusiones}
    ...
    \begin{wideitemize}
        ...
        \item <2-> Modelos reducidos podrían subestimar (sobrestimar) las pérdidas totales al no considerar la reconfiguración del equilibrio estratégico.
...
\begin{frame}{Apéndice}{Variable de estrés térmico \hyperlink{frame:datos}{\beamerbutton{Volver}}}
    ...
    \setbeamertemplate{itemize items}[circle]
    \begin{wideitemize}
        \item Información georreferenciada de cultivos dentro de cada país. Identificamos $T_{max}$ y $T_{min}$.
        \item Se considera que la temperatura sigue una trayectoria triangular en el día.
...
\end{frame}
\begin{frame}{Apéndice}{Intervalo CLR}
    \input{tables/results1_clr}
    \input{tables/results2_clr}
...
\begin{frame}{Apéndice}{El caso de Vietnam}
    \begin{figure}
    \caption{Cambio en la producción de Vietnam}
    \centering
    \includegraphics[scale=0.45]{figures/vietnam_qe}
    \label{vietnam_qe}
    \end{figure}
...
\begin{frame}{Apéndice}{El caso de Vietnam}
    \begin{figure}
    \caption{Cambio en costos de los líderes}
    \centering
    \input{tables/costs_change_leaders}
    \end{figure}
