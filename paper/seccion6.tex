...
Las Tablas N°\ref{tab:t6_results} y N°\ref{tab:t6_surplus} presentan los resultados para diferentes escenarios contrafactuales. En este caso, el período relevante para el análisis abarca desde el año 1990 hasta el 2019, por cuanto se trata del período posterior a la cartelización del mercado y previo al choque relacionado a la pandemia COVID.  El escenario base corresponde a la estimación del modelo (Factual), mientras que el primer escenario contrafactual (Contrafactual 1) se obtiene luego de mantener, para cada país, el promedio de la exposición anual al calor extremo entre los años 1970 y 1989, de manera que el escenario contrafactual captura el cambio de tendencia posterior. Esta ddefinición es importante, pues no supone necesariamente un escenario 
