...
\input{tables/table_leaders_followers.tex}
...
A partir de los resultados obtenidos hasta ahora, ha sido posible identificar la sensibilidad de la demanda ante los choques de precios, así como los costos marginales de los países exportadores. Al mismo tiempo, se ha estimado con detalle el impacto del estrés térmico sobre estos costos, lo que permite la construcción de un escenario contrafactual que modifique la acumulación de temperaturas extremas.
