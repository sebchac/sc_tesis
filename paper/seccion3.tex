...
\section{Variedades y cadena de producción del café}
...
\section{Productores y exportadores}
...
En tal sentido, las Figuras N°\ref{fig:arab_br} a N°\ref{fig:arab_vietnam} reflejan la participación de Arábica en la producción de cada país (siendo la producción de Robusta el complemento), mientras que la Figura N°\ref{fig:arab_grupo} presenta la información por grupo exportador. La producción y la exportación están concentradas en zonas tropicales con condiciones particulares de altitud, temperatura y precipitación. Esta característica vuelve al mercado susceptible a choques climáticos y a riesgos de oferta importantes que pueden tener repercusiones sobre los precios y la estabilidad comercial del sector.
...
\begin{figure}[H]
    ...
    \includegraphics[scale = 1]{figures/arab_vietnam}
    \label{fig:arab_vietnam}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
    \caption{Participación de Arábica en la producción de cada grupo exportador}
    \includegraphics[scale = 1]{figures/arab_grupos.png}
    \label{fig:arab_grupo}
    \end{minipage}
\end{figure}
...
\section{Evolución de la competencia}
