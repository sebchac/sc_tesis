...
Pero no solo existe una diferencia a nivel de ingresos, sino también con relación a la vulnerabilidad frente al cambio climático y sus consecuencias. Al respecto, el Índice de la Iniciativa Global de Adaptación de la Universidad de Notre Dame (ND-GAIN), que pondera cerca de 40 factores económicos, políticos, ambientales y sociales para estimar el grado de preparación de un país frente al cambio climático \citep{gain2024}, muestra una diferencia relevante entre grupos. Siguiendo la interpretación del índice, en la que un índice más alto refleja menor vulnerabilidad frente al cambio climático, los países importadores estarían mejor preparados. Esto reafirma la apreciación de Igami y refuerza la importancia de cuantificar el impacto climático sobre el mercado internacional del café y su distribución entre grupos de países.
...
La oferta del grano de café está determinada principalmente por un grupo de 57 países exportadores, de los cuales, Brasil, Viet Nam y Colombia concentran alrededor del 50\%. Así, la producción y la exportación están concentradas en zonas tropicales con condiciones particulares de altitud, temperatura y precipitación. Esta característica vuelve al mercado susceptible a choques climáticos y a riesgos de oferta importantes que pueden tener repercusiones sobre los precios y la estabilidad comercial del sector.
