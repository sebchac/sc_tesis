...
Pero no solo existe una diferencia a nivel de ingresos, sino también con relación a la vulnerabilidad frente al cambio climático y sus consecuencias. Al respecto, el Índice de la Iniciativa Global de Adaptación de la Universidad de Notre Dame (ND-GAIN), que pondera cerca de 40 factores económicos, políticos, ambientales y sociales para estimar el grado de preparación de un país frente al cambio climático \citep{gain2024}, muestra una diferencia relevante entre grupos. Siguiendo la interpretación del índice, en la que un valor más alto refleja menor vulnerabilidad frente al cambio climático, los países importadores estarían mejor preparados. Esto reafirma la apreciación de Igami y refuerza la importancia de cuantificar el impacto climático sobre el mercado internacional del café y su distribución entre grupos de países.
...
\begin{figure}[H]
    \centering
    \caption{Participación de Arábica en la producción de Viet Nam}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \caption{Participación de mercado de Brasil, Colombia y Viet Nam}
